<?php
    ...
    class Db implements iDb
    {
        ...
        private function __construct()
        {
            ...
            if (isset($panda->dbDNS, $panda->dbUser, $panda->dbPass)) {
                try {
                    if (isset($panda->dbInitCmd)) {
                        $this->_pdo = new PDO($panda->dbDNS, $panda->dbUser, $panda->dbPass, array(PDO::MYSQL_ATTR_INIT_COMMAND => $panda->dbInitCmd));
                    } else {
                        $this->_pdo = new PDO($panda->dbDNS, $panda->dbUser, $panda->dbPass);
                    }

                    $this->_pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                    return;
                } catch (PDOException $e) {
                    throw new Exception('Failed to connect to your database', 500, $e);
                }
            }

            throw new Exception('You must define a dbDNS, dbUser, dbPass within your config', 500, null);
        }
